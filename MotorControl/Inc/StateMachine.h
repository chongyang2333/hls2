...
#define INNER_TORQUE_MODE           (INT16)(-4)
#define INNER_VELOCITY_MODE         (INT16)(-3)
...
//    UINT16      bDcSyncActive;
//    UINT16      nEcatAlStatus;

//    CiA402_PARAM        *Objects; /**< \brief CiA402 Axis object variable*/
...
//PROTO TCiA402Axis       LocalAxes[2];

PROTO void CiA402_Init(void);
PROTO void CiA402_LocalError(UINT16 NodeID, UINT16 ErrorCode);
PROTO void CiA402_StateMachine(void);
PROTO void CiA402_MotionControl(void);
PROTO void ClearScramStatus(UINT16 ScramID);
