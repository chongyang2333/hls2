...
#define PWM_PERIOD_VALUE   (10000)  /* PWM Period Value  100us */
#define SYSTEM_FRQ          200000000
...
struct CurrentLoopStruct
{
    ...
    REAL32	IValidFdb;           //  I Valid value Feedback  // 有效值
...
struct SpeedLoopStruct
{
	...
	REAL32  SpdRefActul;     // 实际s曲线控制后的速度

/*	REAL32 Acc;				// 加速度
	REAL32 SpdRefActul;     // 实际s曲线控制后的速度
	REAL32 CoeffA1;			// 多项式系数
    REAL32 CoeffA2;
	REAL32 CoeffA3;
	REAL32 CoeffA4;
	REAL32 CoeffA5;
	REAL32 Counts;
	REAL32 SpdRefInc;		// 给定速度变化量
